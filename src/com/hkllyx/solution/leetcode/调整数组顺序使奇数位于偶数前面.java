 ...
 * @date 2021/06/04
 */
@Solution(no = "剑指 Offer 21", title = "调整数组顺序使奇数位于偶数前面", difficulty = Difficulty.EASY, url = "https://leetcode-cn.com/problems/diao-zheng-shu-zu-shun-xu-shi-qi-shu-wei-yu-ou-shu-qian-mian-lcof/")
